...
class ChatService {
  ...
  async fetchChatHistory() {
    try {
      const response = await fetch('https://polling-backend-b3s5.onrender.com/api/chat/messages');
  ...
  async fetchParticipants() {
    try {
      const response = await fetch('https://polling-backend-b3s5.onrender.com/api/participants');
      const data = await response.json();
